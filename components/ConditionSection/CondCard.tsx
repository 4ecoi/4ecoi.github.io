  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 mb-1">
        <input className="text-center justify-between col-span-2 mb-1 parchment-bg mx-2" onChange={(e) => changeCondName(e.target.value)} value={cond.name} />
      ...
      <div style={{whiteSpace: "pre-wrap"}} onClick={removeCond} className="absolute cursor-pointer -top-3 -right-3 scale-0 rounded transition-colors border p-2 text-xs text-white group-hover:scale-100">🗑️</div>
    </div>
  )
} 
